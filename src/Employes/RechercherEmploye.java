...
public class RechercherEmploye {
	...
	private void initialize() {
		...
		panel_1.setLayout(new MigLayout("", "[115.00][391.00px,grow][9.00:8.00][108px]", "[9.00][19px][11px][36px,grow][11px][85px,grow][][]"));
		...
		maj.setLayout(new MigLayout("", "[115.00][391.00px,grow][9.00:8.00][108px]", "[9.00][19px][11px][36px,grow][11px][85px,grow][][]"));
